...
class Category(models.Model):
    ...
    name = models.CharField(max_length=255)
    slug = models.SlugField( #slug é como se fosse um ID, toda vez que for buscar, vai ser buscado pelo ID(slug)
        unique=True, default=None,
        null=True, blank=True, max_length=255,
    )
...
class Post(models.Model):
    ...
    excerpt = models.CharField(max_length=255) #resumo do post
    ...
    cover_in_post_content = models.BooleanField(
        default=True,
        help_text='Se marcado Exibe a capa dentro do post',
    )
